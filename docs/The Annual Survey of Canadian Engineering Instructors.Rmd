...
*This paper will focus on the design and development of the Survey of Canadian Engineering Instructors (SCEI), from framework to final implemented version. We will describe how the collaboration progressed, providing a narrative and insight into the collaborative research was enacted; highlighting methods and approaches used. We will also discuss the implementation of the survey, and common issues and challenges encountered. We will present data, highlight the preliminary findings and discuss the future of the survey and the research*

**_Keywords: _** *CEEA Research Collaboration, Faculty Attitudes, Survey Design, Educational Research Methods*
...
Upon the conclusion of the 2013 meeting a call went out to all CEEA members soliciting participation, and canvassing for general research questions or areas of interest. The steering committee held initial meetings in the fall of 2013 to determine research questions, identify conceptual frameworks, define a process for collaboration with CEEA members, how the steering committee would work, and the overall timeline for the project.
